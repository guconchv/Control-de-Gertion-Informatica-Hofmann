<%@ Page Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Informe_Cliente.aspx.cs" Inherits="ControlArriendos.Mantencion.Informes.Informe_Cliente" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:ImageButton ID="ImageButton1" runat="server" style="float:right" ImageUrl="~/Imagenes/iconos/atras.png" Height="63px" OnClick="ImageButton1_Click" Width="86px" />
            ...
            <td rowspan="3" style="width: 1024px">
                <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="1001px" BackColor="#99FFCC" BorderStyle="Groove" Font-Names="Verdana" Font-Size="8pt" LinkDisabledColor="Red">
                </rsweb:ReportViewer>
            </td>
            <td>&nbsp;</td>
        </tr>
